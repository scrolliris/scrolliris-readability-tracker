...
```javascript
{
  ...
  "eventKey": "KanaylMKTRuWGJSRczIg_w--", // __anonymous__ key which generated by event on browser
...
Data does not contain user's id, `eventKey` is anonymous key is just generated on
user's browser by each access.
